...
public class BtcCustomMemoryBlockStore implements BlockStore {
    ...
    public BtcCustomMemoryBlockStore(NetworkParameters params) {
    ...
    public Stream<StoredBlock> getBlocks() {
